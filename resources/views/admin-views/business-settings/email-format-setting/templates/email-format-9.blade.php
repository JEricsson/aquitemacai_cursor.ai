                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="email-template-09-max-width">
                                                ...
                                                <span class="d-block">{{ translate('seu_nome') }}</span>
                                                <span class="d-block" >{{ translate('endereço_completo') }}</span>
                                            </td>
                                        </tr>
                                        <td colspan="2">
                                            <table class="w-100">
        ...
        <tr>
            ...
            <span class="privacy">
                ...
                <span class="copyright" id="mail-copyright">
                    {{ $data['copyright_text']?? translate('Copyright_2023_AquiTemAcai._All_right_reserved') }}
                </span>
            </td>
        </tr>
    </tbody>
