...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Instalação do software AquiTemAcai</h2>
        <h6 class="fw-normal">Prossiga passo a passo com dados adequados de acordo com as instruções</h6>
    </div>

    <!-- Progress -->
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Instalação do software AquiTemAcai"
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">Forneça o seu <strong>email da PeC Soluções em Sistemas</strong> e o número do Pedido </p>
                                ...
                                <div class="from-group">
                                    <label for="username" class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              ...
                                              data-bs-html="true"
                                              data-bs-title="Email de cadastro da PeC Soluções em Sistemas">
                                                    <img
