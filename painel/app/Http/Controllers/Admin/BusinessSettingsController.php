...
//                if($request[$item.'_multiple_sort_by']){
//                    PriorityList::query()->updateOrInsert(['name' => $item.'_multiple_sort_by','type' => 'multiple'], [
//                        'value' => $request[$item.'_multiple_sort_by']?json_encode($request[$item.'_multiple_sort_by']):''
//                    ]);
//                }
            }
        }
        ...
        if(Helpers::activation_submit($request['react_license_code'])){
            BusinessSetting::query()->updateOrInsert(['key' => 'react_setup'], [
                'value' => json_encode([
                    ...
                    'react_platform' => 'PeC Soluções em Sistemas'
                ])
            ]);
